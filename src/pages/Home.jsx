...
import bedroom5 from "../assets/bedroom5.png";
import bedroom6 from "../assets/bedroom6.png";
import bedroom7 from "../assets/bedroom7.png";
import perc from "../assets/percentages.png";
            ...
            <SwiperSlide key={id}>
              ...
              >
                <div className="max-w-[1300px] mx-auto px-4 w-full">
                  <div className="w-full max-w-auto bg-transparent lg:p-8 rounded-2xl">
                    {/* Ссылка */}
                    ...
                    {/* Заголовок */}
                    <h1 className="text-[26px] sm:text-[26px] lg:text-[56px] font-medium text-[#FFF] mb-4 max-w-[800px] leading-tight break-words animate-fade-in-title">
                      {title}
                    </h1>

                    {/* Описание */}
                    <p className="text-[14px] lg:text-[16px] text-[#FFF] animate-fade-in-desc">
                      {description}
                    </p>
                  </div>
                </div>
  ...
  justify-content: center;
    ...
    `}
        ...
        <div className="bg-[#fff] p-0 lg:p-[60px_80px] mx-[22px]">
          <div className="max-w-[1300px] mx-auto lg:px-4">
            <div className="flex flex-row justify-between items-center mb-[40px]">
              <div className="text-[1.65rem] font-medium lg:text-[2.3rem] leading-[30px] text-[#122952]">
                Актуальные акции
              </div>
              <Link
            ...
            <div className="flex flex-row flex-wrap lg:flex-nowrap justify-between items-start gap-[24px]">
              <div className="card__item">
                ...
                <div className="mt-[15px]">
                  <div className="text-[12px] lg:text-[14px] text-[#7f8295] mb-[10px]">
                    Акция действует до 11.11.2023
                  </div>
                  <div className="text-[16px] lg:text-[18px] text-[#122952] mb-[15px] h-[60px] line-clamp-2 overflow-hidden">
                    Скидка 15% на все смесители
                  </div>
                  <div className="text-[12px] lg:text-[14px] text-[#4d526c] mb-[15px]">
      ...
      <section className="pt-[80px] pb-[80px] w-full px-4 py-12 bg-gray-50">
        <div className="max-w-[1300px] mx-auto lg:px-4">
          <div className="max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-[44px] items-start relative overflow-hidden">
            {/* Левая колонка — картинки */}
            <div className="relative w-full h-[230px] md:h-[400px] lg:h-[400px] rounded-[10px]">
              {/* Фоновая картинка — занимает всю ширину и высоту колонки */}
              <img
                src={company}
                alt="Фоновая"
                className="absolute right-[0px] w-[80%] lg:w-[80%] lg:h-full object-cover rounded-[10px] shadow-md"
              />
              {/* Верхняя картинка — поверх фона, с отступами и рамкой */}
              <div className="absolute top-[35%] left-[0%] z-20 p-2 bg-white rounded-[10px] shadow-xl">
                <img
                  src={company3}
                  alt="Верхняя"
                  className="w-[165px] md:w-[320px] lg:w-[330px] rounded-[10px] h-auto object-contain"
                />
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="text-[26px] lg:text-[46px] font-500 text-[#122952] mb-[40px]">
                О компании
              </div>
              ...
              <p className="text-[16px] lg:text-[20px] font-[500] text-[#122952]">
