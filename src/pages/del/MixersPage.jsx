...
const catalogCategories = [
  { name: "Смесители", slug: "/catalog/mixers/", image: smesCat },
  { name: "Душевые системы", slug: "/catalog/showers/", image: dushCat },
  { name: "Душевые стойки", slug: "/catalog/stoyki/", image: stoykiCat },
  { name: "Изливы", slug: "/catalog/izlivy/", image: izlivyCat },
  { name: "Аксессуары", slug: "/catalog/aksessuary/", image: aksessuaryCat },
];
...
const MixersPage = () => {
  ...
  // Берём только товары категории "Смесители"
  const categoryProducts = products.filter((p) => p.category === "Смесители");
  ...
  const filteredProducts = categoryProducts.filter((p) => {
    ...
    // ✅ Фильтр по подкатегориям (Новинки / Хиты / Акции)
    const inCategory =
    ...
    <div>
      ...
      <div className="bg-[#F3F5F7]">
        <div className="max-w-[1300px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[25%_70%] gap-[65px] mb-[80px]">
                ...
                {currentProducts.length ? (
                  currentProducts.map((product) => {
                    ...
                    return (
                      <div
                        key={product.id}
                        className="catalog__content__item flex flex-col flex-[1_0_20%] sm:flex-[1_0_40%] lg:flex-auto w-auto h-auto rounded-[10px] p-[20px_20px] bg-[#FFF] shadow-[0px_10px_20px_rgba(0,0,0,0.2)] cursor-pointer"
                      >
