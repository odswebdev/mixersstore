...
const Footer = () => {
  ...
  focus-within:border-r-[0px] focus-within:border-t-[0px] focus-within:border-t-transparent focus:border-b-1px focus:outline-none focus:border-b-[#F2E] bg-transparent placeholder:text-[14px] placeholder:text-[rgba(255,_255,_255,_0.7)]"
        ...
        <div className="max-w-[1300px] mx-auto px-4">
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="flex flex-col mr-[115px] mb-[30px]">
              ...
              <Link to="tel:+79379676127" className="flex justify-center items-center border-[2px] border-solid border-[#e5e9ec] rounded-[50px] p-[14_28px] w-[217px] h-[60px] bg-[#f3f5f7] opacity-100 cursor-pointer">
                <svg
                  className="mr-[10px]"
                  width="20"
                  height="20"
      ...
      <section className="bg-[#F3F5F7] pt-[20px] pb-[0px] h-[60px]">
        <div className="max-w-[1300px] mx-auto px-4">
