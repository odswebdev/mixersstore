...
const Footer = () => {
  ...
  focus-within:border-r-[0px] focus-within:border-t-[0px] focus-within:border-t-transparent focus:border-b-1px focus:outline-none focus:border-b-[#F2E] bg-transparent placeholder:text-[14px] placeholder:text-[rgba(255,_255,_255,_0.7)]"
      ...
      <section className="pt-[60px] lg:pt-[80px] pb-[80px] bg-[#FFF]">
        <div className="max-w-[1300px] mx-auto px-4">
          {/* Контейнер для 768px и выше */}
          <div className="hidden md:flex flex-col lg:flex-row justify-between items-start">
            {/* Левая колонка - логотип */}
            <div className="flex flex-col mr-[115px] mb-[30px]">
              ...
              <Link 
                to="tel:+79379676127" 
                className="flex justify-center items-center border-[2px] border-solid border-[#e5e9ec] rounded-[50px] p-[14_28px] w-[217px] h-[60px] bg-[#f3f5f7] opacity-100 cursor-pointer"
              >
                <svg
                  className="mr-[10px]"
                  width="20"
            ...
            {/* Правая колонка - ДЛЯ КЛИЕНТА */}
            <div className="flex flex-col w-[32%]">
              <div className="flex flex-col mr-[195px] mb-8">
                <div className="mb-[30px] font-600 text-[16px] text-[rgba(77,_82,_108,_0.5)]">
                  ДЛЯ КЛИЕНТА
                </div>
                <div className="flex flex-col gap-[15px]">
                  <a
              ...
              <div className="flex flex-col">
                ...
                <div className="relative flex flex-row mb-[20px]">
                  <input
                    className="z-3 email__t border border-solid border-[#e5e9ec] rounded-[46px] w-[415px] h-[60px] bg-[#f3f5f7] pl-4 pr-32"
                    type="text"
                    name=""
                    id=""
          ...
          <div className="flex flex-col md:hidden">
            ...
            <div className="mb-6">
              ...
              <Link 
                to="tel:+79379676127" 
                className="flex justify-center items-center border-[2px] border-solid border-[#e5e9ec] rounded-[50px] p-[14_28px] w-full h-[50px] bg-[#f3f5f7] opacity-100 cursor-pointer mb-6"
              >
                <svg
                  className="mr-[10px]"
                  width="18"
            ...
            <div className="mb-8">
              ...
              <div className="relative flex flex-row mb-[15px]">
                <input
                  ...
                  placeholder="Электронная почта"
                />
                <button className="absolute z-10 right-[0px] w-[120px] h-[55px] bg-[#213f74] rounded-[50px] text-[13px] font-[500] text-[#FFF] border-none cursor-pointer hover:bg-[#c19999]">
                  Подписаться
                </button>
              </div>
            </div>
